module LocationHelper
  # All 47 Kenyan counties mapped to their IEBC constituencies (290 total).
  # Keys drive the County select; values drive the cascading Sub-County select.
  KENYA_COUNTIES = {
    "Baringo" => [
      "Baringo Central", "Baringo North", "Baringo South",
      "Eldama Ravine", "Mogotio", "Tiaty"
    ],
    "Bomet" => [
    ...
    "Garissa" => [
      "Balambala", "Dadaab", "Fafi", "Garissa Township", "Ijara", "Lagdera"
    ],
    "Homa Bay" => [
      "Homa Bay Town", "Kabondo Kasipul", "Karachuonyo", "Kasipul",
      "Ndhiwa", "Rangwe", "Suba North", "Suba South"
    ],
    "Isiolo" => [
      "Isiolo North", "Isiolo South"
    ],
    "Kajiado" => [
      "Kajiado Central", "Kajiado East", "Kajiado North",
      "Kajiado South", "Kajiado West"
    ],
    "Kakamega" => [
    ...
    "Kericho" => [
      "Ainamoi", "Belgut", "Bureti", "Kipkelion East",
      "Kipkelion West", "Sigowet/Soin"
    ],
    "Kiambu" => [
      "Gatundu North", "Gatundu South", "Githunguri", "Juja",
      "Kabete", "Kiambaa", "Kiambu", "Kikuyu", "Lari",
      "Limuru", "Ruiru", "Thika Town"
    ],
    "Kilifi" => [
      "Ganze", "Kaloleni", "Kilifi North", "Kilifi South",
      "Magarini", "Malindi", "Rabai"
    ],
    "Kirinyaga" => [
      "Gichugu", "Kirinyaga Central", "Mwea", "Ndia"
    ],
    "Kisii" => [
      "Bobasi", "Bomachoge Borabu", "Bomachoge Chache", "Bonchari",
    ...
    "Kitui" => [
      "Kitui Central", "Kitui East", "Kitui Rural", "Kitui South",
      "Kitui West", "Mwingi Central", "Mwingi North", "Mwingi West"
    ],
    "Kwale" => [
    ...
    "Machakos" => [
      "Kangundo", "Kathiani", "Machakos Town", "Masinga",
      "Matungulu", "Mavoko", "Mwala", "Yatta"
    ],
    "Makueni" => [
      "Kaiti", "Kibwezi East", "Kibwezi West", "Kilome", "Makueni", "Mbooni"
    ],
    "Mandera" => [
      "Banissa", "Lafey", "Mandera East", "Mandera North",
      "Mandera South", "Mandera West"
    ],
    "Marsabit" => [
    ...
    "Meru" => [
      ...
      "Igembe South", "North Imenti", "South Imenti",
      "Tigania East", "Tigania West"
    ],
    "Migori" => [
      "Awendo", "Kuria East", "Kuria West", "Nyatike",
    ...
    "Nairobi" => [
      ...
      "Embakasi East", "Embakasi North", "Embakasi South",
      "Embakasi West", "Kamukunji", "Kasarani", "Kibra",
      "Lang'ata", "Makadara", "Mathare", "Roysambu",
      "Ruaraka", "Starehe", "Westlands"
    ],
    "Nakuru" => [
      "Bahati", "Gilgil", "Kuresoi North", "Kuresoi South",
      "Molo", "Naivasha", "Nakuru Town East", "Nakuru Town West",
    ...
    "Narok" => [
      "Emurua Dikirr", "Kilgoris", "Narok East", "Narok North",
    ...
    "Nyeri" => [
      "Kieni", "Mathira", "Mukurweini", "Nyeri Town", "Othaya", "Tetu"
    ],
    "Samburu" => [
    ...
    "Turkana" => [
      "Loima", "Turkana Central", "Turkana East", "Turkana North",
    ...
    "Wajir" => [
      "Eldas", "Tarbaj", "Wajir East", "Wajir North",
      "Wajir South", "Wajir West"
    ],
    "West Pokot" => [
